...
<head>
	...
	<title>Deskripsi siswa terhadap Pelajaran kelas 11 Uas</title>
...
<body>
	...
	@endif
	<form method="post" enctype="multipart/form-data" action="{{url('/SikapSiswaKelas11Uas/importSikap11Uas')}}">
		{{csrf_field()}}
	...
	<a href="/GuruUas11" class="btn btn-success my-3" target="_blank">Tampilan nilai siswa kelas 11 Uas</a>
	...
	<div class="dropdown" style="float: right;">
		...
		<div class="dropdown-content">
			...
			<a href="SikapSiswaKelas11">Sikap Siswa Uts Kelas 11</a>
			<a href="SikapSiswaKelas12">Sikap Siswa Uts Kelas 12</a>
